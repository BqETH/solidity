...
contract BqETH is PietrzakVerifier {
  ...
  string public name = "BqETH Contract version 0.2";
...
struct PolicyData {
  ...
  returns (uint256) 
  {
      ...
      // This event is needed to ensure the sponsor can fund policies on behalf of users
      ...
      if (verifyProof(mod.N, puzzle.x, d, _y, 0, _proof)) 
      {
            ...
            if (puzzle.sdate < Y3K) {    // last puzzle in the chain ->
              ...
              if (activePuzzles[puzzle.creator] == chain_head) {
                ...
                delete userModuli[puzzle.creator];
              }
            }
      }
      return _pid;
